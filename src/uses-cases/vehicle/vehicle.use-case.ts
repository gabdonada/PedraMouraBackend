...
export class VehicleUseCases {
  ...
  async updateVehicle(body:{vehicleId: string, newKm: number, plate: string, model: string, vehType: string, year: number}) {
    return await this.repository.updateVehicle(body.vehicleId, body.newKm, body.plate, body.model, body.vehType, body.year);
  }
